                    ...
                    case TYPE:
                        switch (*in) {
                            ...
                            case 'i': num = va_arg(args, int);
                                      ...
                                      break;
                            case 'x':
                            case 'X': itohex(va_arg(args, int), string_out_buf);
                                      string_out = string_out_buf;
                                      break;
                            case 's': string_out = va_arg(args, char *);
                                      break;
                            case 'c': string_out_buf[0] = (char)va_arg(args, int);
                                      /* 'char' is promoted to 'int' when passed through '...' */
                                      string_out_buf[1] = 0;
                                      string_out = string_out_buf;
                                      break;
                            case 'f': dnum = va_arg(args, double);
                                      neg_flag = dnum < 0;
                                      if (neg_flag)
                                          string_out_buf[0] = '-';
                                      dtoa(
                                              dnum, 
                                              string_out_buf + neg_flag, 
                                              placeholder_precs);
                                      string_out = string_out_buf;

                                      break; 
                            case '%': string_out_buf[0] = '%';
                                      string_out_buf[1] = 0;
                                      string_out = string_out_buf;
                                      break;
                                      /* 
