...
extern int get_free_pos(page_p p);
extern int get_page_num(page_p p);
extern void put_page_pos(pmsg_level level, page_p p);
extern void print_int(pmsg_level level, int val);
